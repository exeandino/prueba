...
class TextToSpeechICSMR1 {
    ...
    static class C00471 extends UtteranceProgressListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        C00471(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
    ...
    static class C00482 implements OnUtteranceCompletedListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        C00482(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
            this.val$listener = utteranceProgressListenerICSMR1;
        }
    ...
    static void setUtteranceProgressListener(TextToSpeech tts, UtteranceProgressListenerICSMR1 listener) {
        if (VERSION.SDK_INT >= 15) {
            tts.setOnUtteranceProgressListener(new C00471(listener));
        } else {
            tts.setOnUtteranceCompletedListener(new C00482(listener));
        }
    }
}
