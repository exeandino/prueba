...
class SearchViewCompatHoneycomb {
    ...
    static class C00801 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00801(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00812 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00812(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
