...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00271 implements OnWindowAttachListener {
        C00271() {
        }
    ...
    class C00282 implements OnWindowFocusChangeListener {
        C00282() {
        }
    ...
    class C00293 extends BroadcastReceiver {
        C00293() {
        }
    ...
    class C00304 implements OnAudioFocusChangeListener {
        C00304() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00271();
        this.mWindowFocusListener = new C00282();
        this.mMediaButtonReceiver = new C00293();
        this.mAudioFocusChangeListener = new C00304();
        this.mPlayState = 0;
