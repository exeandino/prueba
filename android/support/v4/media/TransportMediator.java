...
public class TransportMediator extends TransportController {
    ...
    class C00262 implements Callback {
        C00262() {
        }
    ...
    class C01901 implements TransportMediatorCallback {
        C01901() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C01901();
        this.mKeyEventCallback = new C00262();
