...
public class ViewPager extends ViewGroup {
    ...
    static class C00581 implements Comparator<ItemInfo> {
        C00581() {
        }
    ...
    static class C00592 implements Interpolator {
        C00592() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C02001 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02001() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02001());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00581();
        sInterpolator = new C00592();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00603();
